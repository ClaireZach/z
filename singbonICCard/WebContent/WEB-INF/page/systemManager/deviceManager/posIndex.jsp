...
<script type="text/javascript">
	...
	function posListClick(tr) {
		...
		var entranceType=tr.attr('entranceType');
		$('#posForm input[name=entranceType]').attr('checked', false);
		$('#posForm input[name=entranceType][value='+entranceType+']').attr('checked', true);
	};
</script>
...
<div class="form posForm" layoutH="30" style="float: left; display: block; overflow: auto; width: 305px; border: solid 1px #CCC; line-height: 21px;">
	<div layoutH="447" style="background: #fff;">
	...
	<form id="posForm" method="post" action="${base }/addEdit.do" class="pageForm required-validate">
		<div class="pageFormContent">
			...
			<dl>
				<dt>绑定门禁：</dt>
				<dd>
					<input type="radio" name="entranceType" checked="checked" value="0" style="width: 15px;"/>不绑定
					<input type="radio" name="entranceType" value="1" style="width: 15px;"/>进门
					<input type="radio" name="entranceType" value="2" style="width: 15px;"/>出门
					<input type="radio" name="entranceType" value="3" style="width: 15px;"/>进出门
				</dd>
			</dl>
			<dl>
				<dt>&nbsp;</dt>
