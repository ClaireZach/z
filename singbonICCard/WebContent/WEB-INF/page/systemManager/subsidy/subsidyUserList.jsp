...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#subsidyUserList .import').click(function(){
			var cardOptions = {
				width : 280,
				height : 170,
				max : false,
			...
			<table border="0">
				...
				<tr>
					<td colspan="10">
						...
						<security:authorize ifAnyGranted="ROLE_ADMIN,ROLE_SUBSIDY_GENERATE_IMPORT">
							<div class="buttonActive" style="margin-left: 10px;">
								<div class="buttonContent">
									<button type="button" class="import">导入补助金额</button>
								</div>
							</div>
						</security:authorize>
