					...
					<ul>
						<li><a href="javascript:;" tvalue="ROLE_SYSTEMSETTING">系统设置</a>
							<ul>
								...
								<li><a href="javascript:;" tvalue="ROLE_ENTRANCE_TIME">进出门时间段</a>
									<ul>
										<li><a href="javascript:;" tvalue="ROLE_ENTRANCE_TIME_SAVE">保存</a></li>
									</ul></li>
							</ul></li>
							...
							<ul>
								...
								<li><a href="javascript:;" tvalue="ROLE_SUBSIDY_GENERATE">生成补助</a>
									<ul>
										...
										<li><a href="javascript:;" tvalue="ROLE_SUBSIDY_GENERATE_IMPORT">导入补助金额</a></li>
					...
					<ul>
						<li><a href="javascript:;" tvalue="ROLE_MAINCARD">用户卡管理</a>
							<ul>
								...
								<li><a href="javascript:;" tvalue="ROLE_MAINCARD_IMPORT">信息导入</a></li>
...
<!-- 								<li><a href="javascript:;" tvalue="ROLE_MAINCARD_OFFNOCARD">无卡注销</a></li> -->
						...
						<li><a href="javascript:;" tvalue="ROLE_CARDREADER_PARAM">读卡机参数下载</a></li>
<!-- 						<li><a href="javascript:;" tvalue="ROLE_CARDREADER_UPGRADE">读卡机升级</a></li> -->
					</ul></li>
				<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER">结算中心</a>
					<ul>
						<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER_USERINFO">用户信息查询</a></li>
						<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER_CONSUME">消费记录查询</a></li>
						<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER_CARDOP">卡操作记录查询</a></li>
						<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER_PERSONAL">个人记录查询</a></li>
						<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER_PERSONALSTAT">个人统计查询</a></li>
						<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER_SUBSIDY">补助记录查询</a></li>
						<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER_SUBSIDYSTAT">补助统计查询</a></li>
						<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER_BALANCE">结算</a></li>
						<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER_DEPTSTAT">部门营业统计</a></li>
						<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER_DEVICESTAT">终端营业统计</a></li>
						<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER_DEPTMEAL">部门就餐统计</a></li>
						<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER_DEVICE">终端营业分析</a></li>
						<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER_ACCOUNTSTAT">结算汇总</a></li>
						<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER_CASHSTAT">出纳汇总</a></li>
						<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER_BALANCESTAT">平衡汇总</a></li>
						<li><a href="javascript:;" tvalue="ROLE_ACCOUNTCENTER_DEPT">部门营业分析</a></li>
					</ul></li>
