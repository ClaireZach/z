	...
	<form action="${base}/list.do" id="pagerForm">
		...
		<div class="searchBar">
			<table border="0">
				<tr align="right">
					<td>用户信息：</td>
					<td><input type="text" name="nameStr" size="10"	value="${nameStr }" id="name" maxlength="32"/>
			   <!-- <td><input type="text" name="nameStr" size="10" id="name" value="${nameStr }" maxlength="32" /> -->
					</td>
					<td width="50">部门：</td>
					<td>
					...
					<td width="80" align="left">
						<select class="combox" outerw="50" innerw="70" name="dateType">
							...
							<option value="0" width="70">消费日期</option>
...
<div class="pageContent"
	...
	<div class="panelBar">
		<div class="pages">
			<span>每页显示</span> <select class="combox" name="numPerPage"onchange="navTabPageBreak({numPerPage:this.value}, 'consumeRecordList')">
