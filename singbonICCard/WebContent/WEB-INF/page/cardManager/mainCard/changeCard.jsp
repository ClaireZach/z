							...
							if(e4.r==1){
								...
								tds.each(function(e){
									...
									if(attr.indexOf('Fare')!=-1){
										var tmp=(e2value*100).toFixed(0);
										$('#userInfo input[name='+attr+']').val(tmp);										
									}else{
...
// 								库信息解挂注销卡操作记录用							
								$('#userInfo input[name=dbOddFare]').val((e4['oddFare']*100).toFixed(0));
								$('#userInfo input[name=dbSubsidyOddFare]').val((e4['subsidyOddFare']*100).toFixed(0));
