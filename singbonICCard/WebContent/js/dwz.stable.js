			...
			$trs.hoverClass().each(function(){
				...
				$tr.click(function(){
					...
					if(target=="batch"){
						...
						transferClick($(this));
					}else if(target=="smartSchoolAdmin"){
						smartSchoolAdminClick($(this));
					}else if(target=="smartSchoolAdminDept"){
						smartSchoolAdminDeptClick($(this));
					}else if(target=="entranceTime"){
						entranceTimeClick($(this));
					}
