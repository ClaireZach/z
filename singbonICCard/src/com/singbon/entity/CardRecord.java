...
public class CardRecord implements Serializable {
	...
	private BigDecimal cardOddFare;
	private BigDecimal cardSubsidyOddFare;
	...
	public void setOpFare(BigDecimal opFare) {
		this.opFare = opFare;
	}
	...
	public BigDecimal getCardOddFare() {
		return cardOddFare;
	}

	public void setCardOddFare(BigDecimal cardOddFare) {
		this.cardOddFare = cardOddFare;
	}

	public BigDecimal getCardSubsidyOddFare() {
		return cardSubsidyOddFare;
	}

	public void setCardSubsidyOddFare(BigDecimal cardSubsidyOddFare) {
