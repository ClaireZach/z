...
public interface SubsidyDAO extends BaseDAO {
	 ...
	 * @throws Exception
	 */
	public void importSubsidy(@Param("companyId") Integer companyId, @Param("userId") String userId, @Param("subsidyFare") Float subsidyFare, @Param("subsidyVersion") Integer subsidyVersion,
			@Param("invalidDate") String invalidDate, @Param("status") Integer subsidyStatus) throws Exception;
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public Map selectUserSubsidyInfo(@Param("companyId") Integer companyId, @Param("userNO") String userNO);
