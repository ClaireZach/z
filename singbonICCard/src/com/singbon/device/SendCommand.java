...
public class SendCommand {
	...
	// 升级用
	private Integer upgradeIndex;
	private Integer upgradeCount;
	private Integer upgradeTotalSize;
	...
	public void setUpgradeIndex(Integer upgradeIndex) {
	...
	public Integer getUpgradeTotalSize() {
		return upgradeTotalSize;
	}

	public void setUpgradeTotalSize(Integer upgradeTotalSize) {
		this.upgradeTotalSize = upgradeTotalSize;
	}
