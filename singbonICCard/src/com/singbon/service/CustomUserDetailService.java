...
public class CustomUserDetailService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String loginInfo) throws UsernameNotFoundException {
		...
		if (!"0".equals(operId)) {
			userDetail = new User(username, password, true, true, true, true, obtainUserPowers(args));
		}
		return userDetail;
	}

	public Collection<GrantedAuthority> obtainUserPowers(String args[]) {
		...
		List<String> rolesList = this.authorizationDAO.selectRolesByOperId(Integer.parseInt(operId));
